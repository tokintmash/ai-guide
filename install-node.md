...
description: Choose the graphical Node.js LTS installer instructions for Mac or Windows.
---

<p class="eyebrow">Only when the local agent says Node is missing</p>
...
<div class="path-grid">
  ...
  <a class="path-card" href="../install-node-windows/">
    ...
    <span class="card-action">Open the Windows instructions ></span>
  </a>
</div>

<div class="assistant-note">
Use the page that matches the user's operating system. Do not substitute Homebrew, winget, Chocolatey, a version manager, or a command pasted into a shell.
</div>
