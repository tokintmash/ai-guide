...
The Windows Codex instructions were last reviewed on **29 July 2026**. See [the raw source list](https://raw.githubusercontent.com/tokintmash/ai-guide/main/sources.md) for the official references and maintenance rules.
